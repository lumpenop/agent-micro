...
function applyLanguage(language) {
  ...
  setCopy('#windows-download-button', ['Download for Windows <small>Agent Micro Setup 1.2.5.exe</small>'], english);
  setCopy('.github-star-link', ['★ Star on GitHub'], english);
  setCopy('.download-meta', ['macOS · Windows · Open source · MIT · Codex CLI'], english);
  setCopy('.download-warning', ['Public beta. Download <strong>Agent Micro Setup 1.2.5.exe</strong> from the GitHub Release.'], english);
